...
export function Navbar(_props) {
  ...
  // Navbar styling from react strap and some vanilla css as well
  return (
    <Nav tabs>
      <NavbarBrand
        href=""
      ...
      {/* If not logged in - shows a logout button on the Navbar - used vanilla CSS to get position right */}
      {Auth.loggedIn() ? (
        <>
          <NavItem>
            <Button
